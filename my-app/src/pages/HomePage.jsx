    ...
    {/* <Box bgColor={"black"}>  */}
      ...
      <Box width={{ base: "90%", sm: "90%", md: "90%", lg: "85%" }} margin="auto" >
        ...
        <Text
          ...
          borderBottomColor={"#f89f17"} >Our Benefits</Text>
      ...
      <Box width={{ base: "90%", sm: "90%", md: "90%", lg: "85%" }} margin="auto" >
        <Text
          ...
          borderBottomWidth="5px"
          marginTop={{ base: 2, sm: 3, md: 7, lg: 10 }}
          borderBottomColor={"#f89f17"} >Unmissable Offers
        </Text>
        <UnMissSlider />
      </Box>
      ...
      <Box width={{ base: "90%", sm: "90%", md: "90%", lg: "85%" }} margin="auto"  >
        ...
        <Grid
          templateColumns={{ base: 'repeat(2, 1fr)', sm: 'repeat(3, 1fr)', md: 'repeat(4, 1fr)', lg: 'repeat(4, 1fr)' }}
          gap={6}
          ...
          <Image display={{ base: "none", sm: "none", md: "block", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=300,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LSUber-Desktop-Promowidget18-Banner7-01March23.jpg" />

          <Image display={{ base: "none", sm: "none", md: "block", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=300,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LSUber-Desktop-Promowidget18-Banner8-01March23.jpg" />
        </Grid>
      </Box>
      ...
      <Box width={{ base: "90%", sm: "90%", md: "90%", lg: "85%" }} margin="auto"  >
        <Text
          ...
          borderBottomWidth="5px"
          marginTop={{ base: 5, sm: 6, md: 7, lg: 10 }}
          borderBottomColor={"#f89f17"} >Big Brands Big Discounts
        </Text>
        <Grid
          ...
          <Image display={{ base: "block", sm: "none", md: "block", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=616,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LS-UberHP-Top-Brands-Desk-Banner8-16Dec2022.jpg" />

          <Image display={{ base: "none", sm: "none", md: "block", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=616,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LS-UberHP-Top-Brands-Desk-Banner11-16Mar2023.jpg" />

          <Image display={{ base: "none", sm: "none", md: "none", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=616,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LS-UberHP-Top-Brands-Desk-Banner12-31Jan2023.jpg" />

          <Image display={{ base: "none", sm: "none", md: "none", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=616,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LS-UberHP-Top-Brands-Desk-Banner4-16Mar2023.jpg" />
        </Grid>
      ...
      <Box width={{ base: "90%", sm: "90%", md: "90%", lg: "85%" }} margin="auto"  >
        <Text
          ...
          borderBottomWidth="5px"
          marginTop={{ base: 5, sm: 6, md: 7, lg: 10 }}
          borderBottomColor={"#f89f17"} >Welcome Summer</Text>
        <Grid
          templateColumns={{ base: 'repeat(2, 1fr)', sm: 'repeat(3, 1fr)', md: 'repeat(4, 1fr)', lg: 'repeat(4, 1fr)' }}
          gap={6}
          marginTop={{ base: 3, sm: 4, md: 6, lg: 7 }} >
          ...
          <Image display={{ base: "none", sm: "none", md: "block", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=300,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LS-UberHP-Promowidget21-Desk-Banner7-14Feb23.jpg" />

          <Image display={{ base: "none", sm: "none", md: "block", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=300,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LS-UberHP-Promowidget21-Desk-Banner8-14Feb23.jpg" />
        </Grid>
      </Box>
      ...
      <Box width={{ base: "90%", sm: "90%", md: "90%", lg: "85%" }} margin="auto" mb={"30px"} >
        <Text
          ...
          borderBottomWidth="5px"
          marginTop={{ base: 5, sm: 6, md: 7, lg: 10 }}
          borderBottomColor={"#f89f17"} >Big Brands Big Discounts</Text>
        <Grid
          templateColumns={{ base: 'repeat(3, 1fr)', sm: 'repeat(4, 1fr)', md: 'repeat(5, 1fr)', lg: 'repeat(6, 1fr)' }}
          gap={4}
          marginTop={{ base: 3, sm: 4, md: 6, lg: 7 }} >
          ...
          <Image display={{ base: "block", sm: "none", md: "block", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=616,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LSUber-Desktop-Promowidget19-Banner9-24Mar23.jpg" />

          <Image display={{ base: "none", sm: "none", md: "block", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=616,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LSUber-Desktop-Promowidget19-Banner10-20Dec22.jpg" />

          <Image display={{ base: "none", sm: "none", md: "none", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=616,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LSUber-Desktop-Promowidget19-Banner11-20Feb23.jpg" />

          <Image display={{ base: "none", sm: "none", md: "none", lg: "block" }} src="https://lmsin.net/cdn-cgi/image/w=616,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/LSUber-Desktop-Promowidget19-Banner12-21Dec22.jpg" />
        </Grid>
      </Box>
