...
const Footer = () => {
    return (
        <Box
                ...
                <Flex
                    ...
                    <Box >
                        <Text
                            color={"black"}
                            fontWeight="bold"
                            fontSize={{ base: "15px", sm: "20px", md: "20px", lg: "22px" }} textAlign="center">
                    ...
                    <Box >
                        ...
                        <Flex
                            ...
                            gap={5}
                            marginTop={7}>
                            <Image width={{ base: "40%", sm: "25%", md: "40%", lg: "20%" }}
            ...
            <Grid mt={"50px"} gridTemplateColumns={{ base: "repeat(2,1fr)", sm: "repeat(3,1fr)", md: "repeat(4,1fr)", lg: "repeat(5,1fr)" }} rowGap={10} ml="5%" >
            ...
            <Flex
                color={"black"}
                justifyContent="space-between"
                flexDir={{ lg: "row", md: "row", sm: "column", base: "column" }} mt="30px">
                <Grid
                    ...
                    <Flex
                        ...
                        <Box
                            ...
                            height="50px"
                            pt="6%"
                            pl="6%" borderRadius={"50%"} >
                            <MdCall fontSize={"24px"} />
                        </Box>
                        <Box>
                            <Text color={"gray"} fontSize={"14px"}>Talk to us</Text>
                    ...
                    <Flex
                        ...
                        <Box>
                            <Text color={"gray"} fontSize={"14px"}>Helpcentre</Text>
                    ...
                    <Flex
                        ...
                        <Box>
                            <Text color={"gray"} fontSize={"14px"}>Write to us</Text>
                            <Text>help@outfitstore.com</Text>
                        </Box>
                    </Flex>
                </Grid>
            ...
            <Box>
                <Flex
                    ...
                    <Box>
                        <Text color={"gray"} fontSize={{ base: "12px", sm: "14px", md: "14", lg: "14px" }}>
