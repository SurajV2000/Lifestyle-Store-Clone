...
import { MdOutlineLocalShipping, MdOutlineAddToHomeScreen } from "react-icons/md"
            ...
            <Flex width="80%" margin="auto" justifyContent={"space-between"} alignItems="center" >
                ...
                <Flex justifyContent={"space-around"} width="55%" alignItems="center">
                    ...
                    <Flex _hover={{ cursor: "pointer" }}>
                        ...
                        <Box className="topnavoffer" fontFamily='sans-serif' color={"white"} fontWeight='500' fontSize='15px' pl='13px' >
                            Free shipping
                        </Box>
                    </Flex>
                ...
                <Flex justifyContent={"space-evenly"} width="35%" alignItems="center" >
                    ...
                    <Box _hover={{ cursor: "pointer" }}>
                        <Box className="topnavoffer" fontFamily='sans-serif' color={"white"} fontWeight='500' fontSize='13px' pl='13px' >
                            Download Our App
                        </Box>
                    </Box>
