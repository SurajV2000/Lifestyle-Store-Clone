...
const getData=()=>{
  axios.get(`https://lifestyle-mock-server-api.onrender.com/${category}`)
  .then((res)=>{
  ...
  const handleDelete=(id)=>{
    console.log(id)
       axios.delete(`https://lifestyle-mock-server-api.onrender.com/men/${id}`)
       .then((res)=>{
        toast({
