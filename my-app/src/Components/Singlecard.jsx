        ...
        <Stack spacing={{ base: 6, md: 10 }}>
          ...
          >
            <VStack spacing={{ base: 4, sm: 6 }}>
              ...
              <Text fontSize={"lg"}>
                Keep your look simple yet stylish by wearing this graceful perky
                A-line piece designed with embroidery on the surface. The outfit
                boasts a round neck, three-quarter sleeves, and a curved
                hemline. Style with a pair of jhumkas and bangles and you are
                good to go.
              </Text>
            </VStack>
            <Box>
